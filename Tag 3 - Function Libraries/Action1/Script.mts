...
Browser("Advantage Shopping").Page("Advantage Shopping").Sync @@ hightlight id_;_263308_;_script infofile_;_ZIP::ssf55.xml_;_
...
Function GetCurrentTime()
	'some other code...
	MyDate = CDate(Now)
	GetCurrentDate = Hour(MyDate) & Minute(MyDate)
End Function
